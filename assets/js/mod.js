  ...
  return {
    ...
    debug: function (t, e) {
      void 0 === console.debug && (console.debug = console.log),
        r <= 1 &&
          console.debug(
            "[" + Log.getDurationString(new Date() - i, 1e3) + "]",
            "[" + t + "]",
            e
          );
    },
    ...
    if (0 < e) {
      for (var i = "", r = 0; r < e; r++)
        0 < r && (i += ","),
          (i +=
            "[" +
            Log.getDurationString(t.start(r)) +
            "," +
            Log.getDurationString(t.end(r)) +
            "]");
      return i;
    }
    return "(empty)";
...
(DataStream.prototype = {}),
  ...
  (DataStream.prototype.readCString = function (t) {
    ...
    return (
      null != t ? (this.position += r - s) : s != e && (this.position += 1), a
    );
  });
...
(DataStream.prototype.readInt64 = function () {
  ...
  (DataStream.prototype.writeType = function (t, e, i) {
    ...
    switch (
      ("string" == typeof t &&
        /:/.test(t) &&
        ((t = (r = t.split(":"))[0]), (s = parseInt(r[1]))),
      "string" == typeof t &&
        /,/.test(t) &&
        ((t = (r = t.split(","))[0]), (a = parseInt(r[1]))),
      t)
    ) {
      case "uint8":
        this.writeUint8(e);
    ...
    null != s &&
      ((this.position = i), this._realloc(s), (this.position = i + s));
  }),
  ...
  (MultiBufferStream.prototype.cleanBuffers = function () {
    for (var t, e = 0; e < this.buffers.length; e++)
      (t = this.buffers[e]).usedBytes === t.byteLength &&
        (Log.debug("MultiBufferStream", "Removing buffer #" + e),
  ...
  (MultiBufferStream.prototype.findEndContiguousBuf = function (t) {
    ...
    if (this.buffers.length > t + 1)
      for (
        ...
        (i = this.buffers[e]).fileStart === r.fileStart + r.byteLength;
        e++
      )
        r = i;
...
var BoxParser = {
  ...
  createSampleEntryCtor: function (e, i, t, r) {
    BoxParser.sampleEntryCodes[e].push(i),
      ...
      (BoxParser[i + "SampleEntry"].prototype = new BoxParser[
        e + "SampleEntry"
      ]()),
  ...
  createSampleGroupCtor: function (e, t) {
    (BoxParser[e + "SampleGroupEntry"] = function (t) {
      ...
      (BoxParser[e + "SampleGroupEntry"].prototype =
  ...
  createTrackGroupCtor: function (e, t) {
    (BoxParser[e + "TrackGroupTypeBox"] = function (t) {
      ...
      (BoxParser[e + "TrackGroupTypeBox"].prototype =
...
BoxParser.initialize(),
  ...
  (BoxParser.parseOneBox = function (t, e, i) {
    ...
    if (
      (Log.debug(
        "BoxParser",
        "Found box of type '" + h + "' and size " + o + " at position " + a
      ),
      (n = 8),
      "uuid" == h)
    ) {
    ...
    if (1 == o) {
      ...
      if (i) o = i;
        ...
        return (
          Log.error(
            "BoxParser",
            "Unlimited box size not supported for type: '" + h + "'"
          ),
    ...
    for (; t.getPosition() < this.start + this.size; ) {
      ...
      this.boxes.push(i),
        this.subBoxNames && -1 != this.subBoxNames.indexOf(i.type)
          ...
          ? Log.warn(
              "Box of type " + e + " already stored in field of this type"
            )
          : (this[e] = i);
    }
  }),
  ...
  BoxParser.createFullBoxCtor("elst", function (t) {
    ...
    for (var e = t.readUint32(), i = 0; i < e; i++) {
      ...
      this.entries.push(r),
        1 === this.version
          ? ((r.segment_duration = t.readUint64()),
            (r.media_time = t.readInt64()))
          : ((r.segment_duration = t.readUint32()),
  ...
  BoxParser.createFullBoxCtor("esds", function (t) {
    ...
    void 0 !== MPEG4DescriptorParser &&
      ...
      (this.esd = t.parseOneDescriptor(
        new DataStream(e.buffer, 0, DataStream.BIG_ENDIAN)
      )));
  }),
  ...
  BoxParser.createFullBoxCtor("iinf", function (t) {
    ...
    for (var i = 0; i < this.entry_count; i++) {
      if (
        ...
        return;
      "infe" !== e.box.type &&
        Log.error("BoxParser", "Expected 'infe' box, got " + e.box.type),
  ...
  BoxParser.createFullBoxCtor("iref", function (t) {
    ...
    for (this.references = []; t.getPosition() < this.start + this.size; ) {
      ...
      )(e.type, e.size, e.hdr_size, e.start)).write ===
  ...
  BoxParser.createSampleGroupCtor("alst", function (t) {
    var e,
      i = t.readUint16();
    for (
      this.first_output_sample = t.readUint16(), this.sample_offset = [], e = 0;
      e < i;
      e++
    )
  ...
  BoxParser.createFullBoxCtor("stsd", function (t) {
    ...
    for (this.entries = [], r = t.readUint32(), e = 1; e <= r; e++) {
      ...
      BoxParser[i.type + "SampleEntry"]
        ? (((s = new BoxParser[i.type + "SampleEntry"](i.size)).hdr_size =
            i.hdr_size),
          (s.start = i.start))
  ...
  BoxParser.createFullBoxCtor("stts", function (t) {
    var e,
      ...
      r = t.readUint32();
    if (
      ((this.sample_counts = []), (this.sample_deltas = []), 0 === this.version)
    )
      for (e = 0; e < r; e++)
        this.sample_counts.push(t.readUint32()),
          (i = t.readInt32()) < 0 &&
  ...
  (BoxParser.trefBox.prototype.parse = function (t) {
    for (var e; t.getPosition() < this.start + this.size; ) {
      if (
        ...
        return;
      (e = new BoxParser.TrackReferenceTypeBox(
        e.type,
        e.size,
        e.hdr_size,
        e.start
      )).write === BoxParser.Box.prototype.write &&
        "mdat" !== e.type &&
        (Log.info(
          "BoxParser",
          "TrackReference " +
  ...
  BoxParser.createFullBoxCtor("vvcC", function (t) {
    ...
    if (
      ...
      for (e = this.num_sublayers; e <= 8 && 1 < this.num_sublayers; ++e)
        i.extract_bits(1);
      for (e = this.num_sublayers - 2; 0 <= e; --e)
        this.ptl_sublayer_present_mask & (1 << e) &&
          (this.sublayer_level_idc[e] = t.readUint8());
      if (
    ...
    for (var n = t.readUint8(), o = 0; o < n; o++) {
      ...
      var d = 1;
      for (
        13 != h.nalu_type && 12 != h.nalu_type && (d = t.readUint16()), e = 0;
        e < d;
        e++
      ) {
        var l = t.readUint16();
            ...
            (this.hvcC.general_constraint_indicator[r] || s) &&
              ((a =
                ...
                BoxParser.decimalToHex(
                  this.hvcC.general_constraint_indicator[r],
                  0
                ) +
                a),
              (s = !0));
  ...
  (BoxParser.vvc1SampleEntry.prototype.getCodec =
    BoxParser.vvi1SampleEntry.prototype.getCodec =
      function () {
        var t = BoxParser.SampleEntry.prototype.getCodec.call(this);
        if (this.vvcC) {
          ...
          if (this.vvcC.general_constraint_info) {
            ...
            if (void 0 === i) e = ".CA";
              ...
              e = ".C";
              for (
                var a = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", n = 0, o = 0, h = 0;
                h <= i;
                ++h
              )
  ...
  (BoxParser.vp08SampleEntry.prototype.getCodec =
    BoxParser.vp09SampleEntry.prototype.getCodec =
      function () {
        var t = BoxParser.SampleEntry.prototype.getCodec.call(this),
          e = this.vpcC.level;
        0 == e && (e = "00");
        ...
        return (
          8 == i && (i = "08"), t + ".0" + this.vpcC.profile + "." + e + "." + i
        );
      }),
  ...
  (BoxParser.stscBox.prototype.unpack = function (t) {
    for (var e, i, r = 0, s = 0, a = 0; a < this.first_chunk.length; a++)
      for (
        e = 0;
        e < (a + 1 < this.first_chunk.length ? this.first_chunk[a + 1] : 1 / 0);
        e++
      )
...
XMLSubtitlein4Parser.prototype.parseSample = function (t) {
  ...
  if (t.subsamples && 0 !== t.subsamples.length) {
    if (
      ((i.documentString = r.readString(t.subsamples[0].size)),
...
(ISOFile.prototype.setSegmentOptions = function (t, e, i) {
    ...
    if (!this.restoreParsePosition || this.restoreParsePosition())
      for (;;)
        if (this.hasIncompleteMdat && this.hasIncompleteMdat()) {
          ...
          (t = BoxParser.parseOneBox(this.stream, !1)).code ===
            BoxParser.ERR_NOT_ENOUGH_DATA)
        ) {
      ...
      if (null !== this.onSamples)
        for (e = 0; e < this.extractedTracks.length; e++) {
          ...
          for (
            ...
            Log.debug(
              "ISOFile",
              "Exporting on track #" + a.id + " sample #" + r.nextSample
            );
  ...
  (ISOFile.prototype.seek = function (t, e) {
    ...
    if (this.moov) {
      for (r = 0; r < s.traks.length; r++)
        (i = s.traks[r]),
          (i = this.seekTrack(t, e, i)).offset < a.offset &&
            (a.offset = i.offset),
    ...
    if (void 0 !== BoxParser[e.type + "SampleEntry"]) {
      ...
      e.description && s.addBox(e.description),
        ...
        r
          .add("dinf")
          .add("dref")
          .addEntry(new BoxParser["url Box"]().set("flags", 1));
      t = r.add("stbl");
      return (
    ...
    for (
      ...
      ((e = this.moov.traks[t]).tkhd.duration = 0),
        ...
        (i = e.mdia.minf.stbl.ctts) &&
          ((i.sample_counts = []), (i.sample_offsets = [])),
  ...
  (ISOFile.setSampleGroupProperties = function (t, e, i, r) {
    ...
    for (s in ((e.sample_groups = []), r))
      (e.sample_groups[s] = {}),
        ...
        (e.sample_groups[s].grouping_type_parameter =
        ...
        (v.number = e),
          ...
          0 === e
            ...
            : (_++,
              ...
              (g += r.samples_per_chunk[u])),
          (v.description_index =
            r.sample_description_index[v.chunk_run_index] - 1),
          ...
          o
            ? (e == o.sample_numbers[P] - 1
              ...
              d &&
                ...
                ((v.subsamples = d.entries[U].subsamples),
  ...
  (ISOFile.prototype.updateSampleLists = function () {
    ...
    if (void 0 !== this.moov)
      for (; this.lastMoofIndex < this.moofs.length; )
        if (
          ((n = this.moofs[this.lastMoofIndex]),
          this.lastMoofIndex++,
          "moof" == n.type)
        )
            ...
            for (
              ...
              for (var f = h.truns[y], u = 0; u < f.sample_count; u++) {
                ((p = {}).moof_number = this.lastMoofIndex),
                  ...
                  (p.description =
                    d.mdia.minf.stbl.stsd.entries[p.description_index]),
                  (p.size = r),
                  f.flags & BoxParser.TRUN_FLAGS_SIZE &&
                    (p.size = f.sample_size[u]),
                  (d.samples_size += p.size),
                  (p.duration = i),
                  f.flags & BoxParser.TRUN_FLAGS_DURATION &&
                    (p.duration = f.sample_duration[u]),
                  ...
                  d.first_traf_merged || 0 < u
                    ...
                    : (h.tfdt
                        ? (p.dts = h.tfdt.baseMediaDecodeTime)
                        : (p.dts = 0),
                ...
                (p.offset =
                  ...
                  (0 < h.sbgps.length ||
                    ...
                    ISOFile.setSampleGroupProperties(
                      ...
                      p,
                      p.number_in_traf,
                      h.sample_groups_info
                    );
              }
            if (h.subs) {
              d.has_fragment_subsamples = !0;
              for (
                var x = h.first_sample_index, y = 0;
                y < h.subs.entries.length;
                y++
              )
                (x += h.subs.entries[y].sample_delta),
                  ((p = d.samples[x - 1]).subsamples =
                    h.subs.entries[y].subsamples);
            }
          }
  }),
    ...
    if (null != e && void 0 !== e.hdlr && void 0 !== e.iinf) {
      for (h = 0; h < e.iinf.item_infos.length; h++)
        ((r = {}).id = e.iinf.item_infos[h].item_ID),
          ...
          0 < e.iinf.item_infos[h].protection_index &&
            (r.protection =
              e.ipro.protections[e.iinf.item_infos[h].protection_index - 1]),
      ...
      if (e.iloc)
        for (h = 0; h < e.iloc.items.length; h++) {
          ...
          for (r.extents = [], a = r.size = 0; a < i.extents.length; a++)
            (r.extents[a] = {}),
              (r.extents[a].offset =
                i.extents[a].extent_offset + i.base_offset),
      ...
      if ((e.pitm && (t[e.pitm.item_id].primary = !0), e.iref))
        for (h = 0; h < e.iref.references.length; h++)
          for (
            var s = e.iref.references[h], a = 0;
            a < s.references.length;
            a++
          )
  ...
  (ISOFile.prototype.itemToFragmentedTrackFile = function (t) {
    ...
    i.properties.ispe &&
      ((e.width = i.properties.ispe.image_width),
    ...
    i.write(e),
      ...
      Log.debug(
        ...
        "Adjusting data_offset with new value " +
          i.trafs[0].truns[0].data_offset
      ),
      e.adjustUint32(
        i.trafs[0].truns[0].data_offset_position,
        i.trafs[0].truns[0].data_offset
      );
  ...
  (ISOFile.writeInitializationSegment = function (t, e, i, r) {
    ...
    var n = e.add("mvex");
    for (
      i && n.add("mehd").set("fragment_duration", i), s = 0;
      s < e.traks.length;
      s++
    )
      n.add("trex")
      ...
      (s.mvhd = this.moov.mvhd),
        ...
        (r.buffer = ISOFile.writeInitializationSegment(
          ...
          this.moov.mvex && this.moov.mvex.mehd
            ...
            : void 0,
          0 < this.moov.traks[t].samples.length
